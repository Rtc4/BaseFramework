...
public class KafkaProviderConfig {
    @Value("${spring.kafka.cc.producer.bootstrap-servers}")
    private String bootstrapServers;
    @Value("${spring.kafka.cc.producer.transaction-id-prefix}")
    private String transactionIdPrefix;
    @Value("${spring.kafka.cc.producer.acks}")
    private String acks;
    @Value("${spring.kafka.cc.producer.retries}")
    private String retries;
    @Value("${spring.kafka.cc.producer.batch-size}")
    private String batchSize;
    @Value("${spring.kafka.cc.producer.buffer-memory}")
