package com.cc.framework.kafka.config;
...
public class KafkaConsumerConfig {
    @Value("${spring.kafka.cc.consumer.bootstrap-servers}")
    private String bootstrapServers;
    @Value("${spring.kafka.cc.consumer.group-id}")
    private String groupId;
    @Value("${spring.kafka.cc.consumer.enable-auto-commit}")
    private boolean enableAutoCommit;
    @Value("${spring.kafka.cc.properties.session.timeout.ms}")
    private String sessionTimeout;
    @Value("${spring.kafka.cc.properties.max.poll.interval.ms}")
    private String maxPollIntervalTime;
    @Value("${spring.kafka.cc.consumer.max-poll-records}")
    private String maxPollRecords;
    @Value("${spring.kafka.cc.consumer.auto-offset-reset}")
    private String autoOffsetReset;
    @Value("${spring.kafka.cc.listener.concurrency}")
    private Integer concurrency;
    @Value("${spring.kafka.cc.listener.missing-topics-fatal}")
    private boolean missingTopicsFatal;
    @Value("${spring.kafka.cc.listener.poll-timeout}")
